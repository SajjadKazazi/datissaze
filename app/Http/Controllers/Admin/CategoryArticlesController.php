...
class CategoryArticlesController extends Controller
{
    ...
    {
        $categories = $this->categoryRepository->where('type','article')->orderBy('created_at','DESC')->get();
    ...
    public function store(AddNewCategoryRequest $request): \Illuminate\Http\RedirectResponse
    {
        ...
        return redirect()->route('admin.articles.categories.index')->with('success_add', __('entities/category.success.add'));
    }
    ...
    public function update(UpdateNewsCategoryRequest $request, Category $category): \Illuminate\Http\RedirectResponse
    {
        ...
        return redirect()->route('admin.articles.categories.index')->with('success_add', __('entities/category.success.update'));
