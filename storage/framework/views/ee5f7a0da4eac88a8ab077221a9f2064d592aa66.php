<?php if($articles->isNotEmpty()): ?>
    <section class="container space-y-3 lg:space-y-6 py-3 lg:py-16">
        ...
        <div class="flex justify-between">
            ...
            <div class="">
                <a href="<?php echo e(route('front.index.articles')); ?>"  class="text-white  bg-primary transition-all duration-300 lg:text-base text-sm py-2 px-3 lg:py-4 lg:px-6 hover:bg-primary-second text-center relative before:bg-white before:w-0.5 before:h-3 before:absolute before:top-0 before:right-1/2 before:translate-x-1/2 w-full">
                    مشاهده بیشتر</a>
            </div>
        </div>
        <div class="grid grid-cols-2 lg:grid-cols-4">
            <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="border transition-shadow group duration-300   overflow-hidden flex flex-col pb-4">
                    <div class="aspect-[3/2] overflow-hidden"><img src="<?php echo e(asset($article->thumbnail)); ?>"
                    ...
                    <div class="mt-4 lg:mt-8 space-y-4 flex flex-col lg:px-6 px-3 lg:pb-4  ">
                        ...
                        <div class="flex items-center justify-between mt-4 text-gray-500 text-sm">
                            <span
                                class="font-light"><?php echo e(\Morilog\Jalali\Jalalian::forge($article->created_at)->format('Y/m/d')); ?></span>
...
<?php endif; ?>
<?php /**PATH D:\git\projects\Blogs\datissaze\resources\views/components/front/articles/home.blade.php ENDPATH**/ ?>