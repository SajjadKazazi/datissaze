...
@section('content')
    <x-front.partials.pages.header  title="نمونه کار ها"  :description="$DefaultTextSettings->projects_text" :pic="$GeneralSettings->project_page_image"/>
        ...
        <div id="projects" class="grid grid-cols-2 lg:grid-cols-4 gap-1 lg:gap-2">
            @foreach($projects as $project)
                <div class="px-0.5 lg:px-0">
                    <a href="{{ route('front.single.projects',$project->slug) }}"
