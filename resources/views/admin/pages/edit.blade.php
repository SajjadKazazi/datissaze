...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">ویرایش صفحه</h4>
            ...
            <!-- end page title -->
            <form class="forms-sample" action="{{ route('admin.pages.update',$page->id) }}" method="post"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="title" id="title" value="{{ $page->title }}">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="slug" id="slug" value="{{ $page->slug }}">
                                </div>

                                <div class="mb-3">
                                    <label for="info" class="form-label">محتوای صفحه</label>
                                    <textarea class="ckeditor form-control" name="body" id="body" rows="5">{{ $page->body }}</textarea>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="meta_title" id="meta_title" required
                                           value="{{ $page->meta ? $page->meta->meta_title : '' }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="meta_description" id="meta_description" required
                                           value="{{ $page->meta ? $page->meta->meta_description : '' }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="meta_canonical" id="meta_canonical"
                                           value="{{ $page->meta ? $page->meta->meta_canonical : '' }}">
                                </div>
