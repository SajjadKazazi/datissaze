...
<section class="bg-primary text-white py-5 lg:py-10 px-4 lg:px-5">
    <div id="customers" class="">
        <?php $__currentLoopData = $cooperators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cooperator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div>

                <div class="flex justify-center items-center">
                    <img src="<?php echo e(asset($cooperator->img)); ?>" alt="">
                </div>
            </div>
...
<?php /**PATH D:\git\projects\Blogs\datissaze\resources\views/components/front/cooperators/home.blade.php ENDPATH**/ ?>