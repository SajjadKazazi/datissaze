            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">لیست اخبار</h4>
                                    ...
                                    <div class="mb-4">
                                        <a href="{{ route('admin.news.create') }}"
                                           class="btn btn-light waves-effect waves-light"><i
                                                class="bx bx-plus me-1"></i>ایجاد خبر</a>
                                    </div>
                                </div>
                                    ...
                                    @forelse ($news as $new)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-square btn-danger delete_news"
                                                        data-news="{{ $new->id }}"><i class="bx bxs-trash"></i>
                                                </button>
                                            </td>
