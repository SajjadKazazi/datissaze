            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">افزودن سرویس جدید</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="slug" autocomplete="off" placeholder="ضروری" name="slug" value="{{ old(('slug')) }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <input dir="ltr" type="text" id="image_label" class="form-control" name="image" placeholder="اختیاری"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="is_home" id="" class="form-select">
